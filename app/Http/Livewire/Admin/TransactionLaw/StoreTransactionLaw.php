...
class StoreTransactionLaw extends BaseComponent
{
    ...
    public function deleteItem(SettingRepositoryInterface $settingRepository)
    {
        ...
        return redirect()->route('admin.transaction.law');
    }

    public function render()
    {
        return view('livewire.admin.transaction-law.store-transaction-law')->extends('livewire.admin.layouts.admin');
    }
}
