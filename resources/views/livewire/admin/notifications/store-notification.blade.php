<div>
    ...
    <div class="card card-custom gutter-b example example-compact">
        ...
        <div class="card-body">
            ...
            <x-admin.forms.dropdown id="subject" :data="$data['subject']" label="موضوع*" wire:model.defer="subject"/>
            <x-admin.forms.dropdown id="type" :data="$data['type']" label="نوع اعلان*" wire:model.defer="type"/>
