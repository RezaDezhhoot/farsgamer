    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('{{asset(auth()->user()->profile_image)}}')"></div>
        ...
        <div>
            ...
            <!--end:Heading-->
            <!--begin::Item-->
            @foreach(auth()->user()->alerts()->orderBy('id','desc')->get() as $item)
...
<!-- end::User Panel-->
@include('livewire.admin.layouts.foot')
@stack('scripts')
</body>
</html>
